    ...
    <main>
      ...
      <section className="page-section about-profile">
        ...
        <div className="prose">
          ...
          <p>Beyond the laboratory, I am committed to widening participation in research and technology. I joined WomenTech Network as a member in May 2020 and became a Global Ambassador representing South Korea on June 24, 2020. I also volunteer as a Content Developer with the National Postdoctoral Association. During a one-year term spanning 2025 and 2026, I served as Seminar Coordinator for the women-empowerment group at the Prof. Cosmas Daughters Forum, where I invited speakers, planned events, anchored seminars, and moderated conversations on career mobility and well-being. I approach scholarship as a public and collaborative practice that should prepare thoughtful researchers and create pathways for others.</p>
        </div>
      </section>
