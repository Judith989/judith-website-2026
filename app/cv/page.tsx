...
export default function CvPage() {
  return (
    <main>
      <PageHero title="Curriculum vitae" />
        ...
        <div className="cv-main">
          ...
          <div className="cv-block"><p className="kicker">Teaching and mentorship</p>
            <article><span>2026 to Present</span><div><h2>Research mentor</h2><p>Mentoring six interdisciplinary teams across graduate, undergraduate, and high-school levels at the University of Wyoming.</p></div></article>
              <article><span>Mar to May 2026</span><div><h2>Project research mentor, <em>Machine Learning</em> (COSC 4555/5555)</h2><p>Guided student projects in model implementation, evaluation, and interpretation at the University of Wyoming.</p></div></article>
              <article><span>2019 to 2025</span><div><h2>Teaching and course materials</h2><p>Supported <em>Introduction to Probability</em> and <em>Real-Time Systems</em> instruction; developed hardware-in-the-loop simulation materials with MATLAB and graduate research-writing guidance.</p></div></article>
      ...
      <section className="page-section professional-service">
        <div className="gallery-lead"><h2>Leadership and professional service</h2></div>
