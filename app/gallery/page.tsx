...
import GalleryGrid, { type GalleryAlbum } from "./gallery-grid";
...
const metaverseWorkshop = [
  { src: "/gallery/metaverse-workshop-linkedin-1.jpg", alt: "Judith Njoku-Vowels speaking during the virtual Metaverse and The Industry Workshop", caption: "Speaking during the two-day hybrid workshop, which connected the ICT Convergence Research Center at Kumoh National Institute of Technology with participants and partner institutions in Nigeria." },
  { src: "/gallery/metaverse-workshop-linkedin-2.jpg", alt: "Metaverse and The Industry Workshop team in front of the event display", caption: "Members of the on-site workshop team in Gumi, South Korea. The event brought researchers and collaborators together across South Korea and Nigeria to discuss how metaverse research could translate into industrial applications." },
  { src: "/gallery/metaverse-workshop-linkedin-3.jpg", alt: "Judith Njoku-Vowels in front of the Metaverse and The Industry Workshop display", caption: "At the Metaverse and The Industry workshop venue in Gumi, South Korea. I co-organized the program and delivered the session on metaverse applicability to transportation systems." },
  { src: "/gallery/metaverse-workshop-linkedin-4.jpg", alt: "Pure Wallet blockchain transaction presentation during the Metaverse workshop", caption: "A live workshop session presenting the general architecture of Pure Wallet and its approach to offline blockchain transactions for connected virtual environments." },
  { src: "/gallery/metaverse-workshop-linkedin-5.jpg", alt: "Proposed offline blockchain transaction system presented during the workshop", caption: "The proposed blockchain system connected sender, receiver, token manager, and miner components, illustrating one of the technical architectures discussed during the workshop." },
  { src: "/gallery/metaverse-workshop-linkedin-6.jpg", alt: "Judith Njoku-Vowels and workshop organizers coordinating the hybrid event", caption: "Working with the on-site organizing team during the hybrid program. The workshop depended on close coordination across presenters, technology, and participants joining from multiple institutions." },
  { src: "/gallery/metaverse-workshop-linkedin-7.jpg", alt: "Projected metaverse industry presentation with virtual participants", caption: "A projected workshop presentation on the growth of metaverse technologies and industry, with participants joining virtually as the on-site audience followed the discussion in Gumi." },
];
...
const momentDates = [
  "2025-07-09", "2025-04-25", "2025-02-19", "2024-11-21", "2024-10-16",
  "2024-08-08", "2024-04-25", "2023-10-12", "2023-08-25", "2023-07-07",
  "2023-06-24", "2023-04-28", "2022-11-30", "2022-10-21", "2022-10-21",
  "2022-06-24", "2022-02-11", "2021-02-05", "2021-02-05", "2020-06-30",
  "2019-11-30",
];

const albums: GalleryAlbum[] = [
  { date: "2026-06-17", title: "PANDA at the ASCE International Conference on Computing in Civil Engineering", description: "I presented PANDA virtually during i3CE 2026, hosted at Songdo Convensia in Songdo, Incheon, South Korea. The presentation demonstrated how a lightweight forecasting model and a Cesium digital twin can turn limited parking data into multi-horizon occupancy and turnover predictions that operators can inspect spatially.", images: pandaPresentation },
  { date: "2026-06-06", title: "OmniRestore at the IEEE/CVF Conference on Computer Vision and Pattern Recognition Workshops", description: "I presented OmniRestore, coauthored with Prof. Diksha Shukla, at the Colorado Convention Center during the conference held June 3 to 7, 2026. The work introduces a lightweight, weather-aware framework for restoring visual information degraded by rain, snow, fog, low light, and composite conditions. Presenting it at CVPR brought this research into conversation with the international computer vision community and marked an important expansion of my work into robust autonomous perception.", images: cvprPresentation },
  { date: "2026-05-06", title: "Facilitating a University of Wyoming community conversation on digital twins", description: "I facilitated the School of Computing's Digital Twins Computing Meet Up at Altitude Chophouse and presented a battery-management digital twin case study. Six lightning talks brought complementary views of digital twins into one room.", images: uwDigitalTwinsMeetup },
  { date: "2025-08-22", title: "PhD graduation", description: "Celebrating the conferral of my PhD in IT Convergence Engineering at Kumoh National Institute of Technology in South Korea.", images: phdGraduation },
  { date: "2022-05-26", title: "Metaverse and The Industry Workshop", description: "I co-organized this two-day workshop with the ICT Convergence Research Center and delivered the transportation-systems presentation. Eight sessions connected metaverse foundations with manufacturing, blockchain, NFTs, artificial intelligence, transportation, research trends, and security.", images: metaverseWorkshop },
  ...
  ...moments.map((moment, index) => ({
    date: momentDates[index],
    title: moment.title,
    images: [{ src: moment.src, alt: moment.title, caption: moment.detail }],
  })),
