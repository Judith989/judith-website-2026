...
const journalNews: NewsItem[] = [
  { date: "May 20, 2026", category: "Internship program publication accepted", title: "Developing Future Workforce Skills through Remote Practical Training accepted for publication in Computers and Education Open", text: "I am thrilled to share that our paper has been accepted for publication in Computers and Education Open. Coauthored with Patience Chizoba Mba, Senorpe Asem-Hiablie, and Daniel Dooyum Uyeh, the paper documents how our remote practical-training model connected Kyungpook National University and Michigan State University, in affiliation with the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University, to build research capability, technical confidence, and future workforce skills. Seeing the internship program become a peer-reviewed contribution is an especially meaningful milestone.", href: "https://doi.org/10.1016/j.caeo.2026.100369" },
  ...
  { date: "August 2025", category: "Post-internship mentorship publication", title: "Enhancing Resilience in Specialty Crop Production in a Changing Climate through Smart Systems Adoption published in Smart Agricultural Technology", text: "I am delighted to celebrate what sustained mentorship can make possible. Following the internship, continued research guidance and collaboration with Patience Chizoba Mba and Daniel Dooyum Uyeh, in affiliation with the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University, grew into this publication in Smart Agricultural Technology. The paper examines how sensing, automation, and decision-support systems can strengthen specialty-crop resilience under a changing climate, and it is a rewarding example of mentorship continuing well beyond the formal end of a program.", href: "https://doi.org/10.1016/j.atech.2025.100897" },
  { date: "March 31, 2025", category: "Cohort 2 internship publication", title: "Advanced Multimodal Prediction of Components of Livestock Feed Materials Using Knowledge Distillation published in IEEE Transactions on AgriFood Electronics", text: "I am incredibly proud to celebrate this research output from Cohort 2 of the Kyungpook National University and Michigan State University internship, in affiliation with the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University. Working with Owoeye Babatunde Oluwabukunmi, Akomolafe Ayobami Joseph, Miraculous Udurume, Cosmas Ifeanyi Nwakanma, Senorpe Asem-Hiablie, Rammohan Mallipeddi, Tusan Park, and Daniel Dooyum Uyeh, we transformed the cohort's research training into a publication in IEEE Transactions on AgriFood Electronics. The study uses knowledge distillation to make multimodal livestock-feed prediction more efficient.", href: "https://doi.org/10.1109/TAFE.2025.3548949" },
  { date: "September 23, 2025", category: "Cohort 3 internship publication", title: "A Digital Twin Framework for Sensor Selection and Microclimate Monitoring in Greenhouses published in AgriEngineering", text: "Excited and deeply proud to celebrate a journal publication produced through Cohort 3 of the Kyungpook National University and Michigan State University internship, in affiliation with the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University. Together with Oreofeoluwa Akintan and the wider research team, we developed a digital-twin framework for informed sensor selection and greenhouse microclimate monitoring. Its publication in AgriEngineering shows what can happen when structured internship mentorship gives emerging researchers ownership of a consequential problem.", href: "https://doi.org/10.3390/agriengineering7100315" },
  ...
  { date: "December 2024", category: "Cohort 2 internship publication", title: "Estimation of Physico-Chemical Properties of Soil Using Machine Learning published in Smart Agricultural Technology", text: "I am excited to celebrate the first peer-reviewed publication from Cohort 2 of the Kyungpook National University and Michigan State University internship, in affiliation with the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University. With Patience Chizoba Mba and our collaborators, we developed and evaluated machine-learning methods for estimating soil properties that support agricultural decision-making. Seeing this internship research mature into a publication in Smart Agricultural Technology is a proud milestone for the students, mentors, and institutions behind the cohort.", href: "/publications" },
...
const journey: NewsItem[] = [
  ...
  { date: "June 6, 2026", category: "Conference presentation", title: "OmniRestore presented at the IEEE/CVF CVPR Workshops in Denver", text: "Pleased to share an exciting milestone for our Secure Sensing and Learning Research Lab team. I presented OmniRestore, our parameter-efficient framework for universal adverse-weather image restoration, at the Colorado Convention Center in Denver, Colorado, during the IEEE/CVF CVPR Workshops held June 3 to 7, 2026.", href: "https://openaccess.thecvf.com/content/CVPR2026W/NTIRE/papers/Njoku_OmniRestore_A_Parameter-Efficient_Framework_for_Universal_Adverse-Weather_Image_Restoration_CVPRW_2026_paper.pdf" },
  ...
  { date: "March 25, 2026", category: "Acceptance", title: "OmniRestore accepted at CVPR Workshops", text: "Congratulations to our full research team on this milestone for efficient restoration across rain, snow, haze, and other adverse conditions.", href: "https://judith989.github.io/CVPRW2026_OmniRestore/" },
  ...
  { date: "August 29, 2025", category: "Appointment", title: "Joined the University of Wyoming and the Secure Sensing and Learning Research Lab", text: "Excited to begin my postdoctoral chapter in Laramie, Wyoming, with the Secure Sensing and Learning Research Lab and the Center for Rural Community Resilience and Innovation at the University of Wyoming. This transition expanded my research into robust computer vision, smart infrastructure, and AI-enabled systems for rural and autonomous environments.", href: "/#bio" },
  { date: "August 22, 2025", category: "Education", title: "PhD degree conferred", text: "Pleased to share that my PhD in IT Convergence Engineering was conferred by Kumoh National Institute of Technology in South Korea on August 22, 2025. I celebrated this graduation with colleagues, mentors, and supporters.", href: "/gallery" },
  ...
  { date: "April 23 to 25, 2025", category: "Conference presentation", title: "PureTwin presented at JCCI 2025 in Sokcho, South Korea", text: "At JCCI 2025, the 35th Joint Conference on Communications and Information, I presented PureTwin, an interactive non-fungible digital twin framework for battery management systems. The conference was held at Sokcho Sonocalm Delpino Resort in South Korea.", href: "/gallery" },
  ...
  { date: "October 1, 2024", category: "Mentorship", title: "Joined the Women in Machine Learning mentorship program as a mentor", text: "Excited to deepen my involvement with Women in Machine Learning by joining its mentorship program as a mentor. Through WiML, I support women developing their direction, confidence, and professional networks in machine learning research and practice.", href: "https://wimlworkshop.org/" },
  ...
  { date: "September 10, 2024", category: "Professional membership", title: "Joined Women in Machine Learning", text: "Pleased to join Women in Machine Learning, a global community advancing the visibility, inclusion, and participation of women in machine learning research and practice.", href: "https://wimlworkshop.org/" },
  ...
  { date: "August 2022", category: "Appointment and research leadership", title: "Joined Kyungpook National University and Michigan State University as a Research Specialist and Supervisor", text: "Excited to begin a cross-institutional role connecting AI-enabled sensing, digital agriculture, explainable machine learning, and international workforce development, with affiliation to the Climate Smart Decision Support Systems Laboratory, CLIMDES, at Michigan State University. From August 2022 to July 2024, I coordinated research collaborations and recruited, supervised, and mentored two international internship cohorts comprising more than 15 students, many of whom became publication coauthors and continued into graduate study.", href: "/cv" },
