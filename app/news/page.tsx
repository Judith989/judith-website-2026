...
const journey: NewsItem[] = [
  ...
  { date: "March 2026", category: "Acceptance", title: "PANDA accepted at i3CE 2026", text: "Congratulations to our coauthor team on the acceptance of PANDA, a lightweight digital twin framework for smart parking management.", href: "https://scholar.google.com/scholar?q=%22PANDA%3A+A+Lightweight+Digital+Twin+Framework+for+Smart+Parking+Management%22" },
  { date: "February 21, 2026", category: "Seminar facilitation", title: "Anchored a PCDF conversation on relationships and intentional growth", text: "I anchored a Prof. Cosmas Development Forum seminar that created an honest, experience-based conversation about love and commitment across life stages, communication and conflict, growth within marriage and singleness, and lessons grounded in lived experience. The interactive session was held virtually on Zoom at 2 p.m. West Africa Time.", href: "https://www.linkedin.com/posts/pcdf-official_valentine2026-interactivesessions-pcdf-activity-7421659965150568448-6s0N" },
  { date: "January 17, 2026", category: "Seminar facilitation", title: "Anchored a PCDF seminar on Canada permanent residence", text: "I anchored a Prof. Cosmas Development Forum Zoom conversation with Cynthia Chidinma Osewemen and Chinwe Phil Ekene, two professionals who had completed the Canadian permanent-residence process. The 2 p.m. West Africa Time session focused on their lived experience, practical lessons, and the realities applicants often understand only after beginning the journey.", href: "https://www.linkedin.com/posts/judith989_some-opportunities-look-simple-on-the-surface-activity-7415902179968135168-bJ1h" },
  { date: "November 15, 2025", category: "Seminar facilitation", title: "Anchored a PCDF seminar on the UK Global Talent Visa", text: "I anchored a Prof. Cosmas Development Forum Zoom seminar with UK Global Talent Visa holder Angela Caliwag. The practical session explained eligibility, application requirements, the step-by-step process, common mistakes, and how the visa can support an international career and a pathway toward permanent residence in the United Kingdom.", href: "https://www.linkedin.com/posts/pcdf-official_globaltalentvisa-ukvisa-careergrowth-activity-7385028052008759296-xdTp" },
  { date: "September 20, 2025", category: "Seminar facilitation", title: "Anchored a PCDF seminar on recognizing and responding to abuse", text: "I anchored a Prof. Cosmas Development Forum Zoom seminar led by counselor and coach Tara Daneshmand. The session examined physical, emotional, and financial abuse, including less visible patterns in workplaces and relationships, and discussed boundaries, self-protection, and routes toward support and restored confidence.", href: "https://www.linkedin.com/posts/pcdf-official_mentalhealthawareness-emotionalwellbeing-activity-7369009563162800128-kiBw" },
  { date: "August 29, 2025", category: "Appointment", title: "Joined the University of Wyoming and the Secure Sensing and Learning Research Lab", text: "I began my postdoctoral chapter in Laramie, Wyoming, joining the University of Wyoming and the Secure Sensing and Learning Research Lab. This transition expanded my research into robust computer vision, smart infrastructure, and AI-enabled systems for rural and autonomous environments.", href: "/about" },
  { date: "August 22, 2025", category: "Education", title: "PhD degree conferred", text: "I received my PhD in IT Convergence Engineering from Kumoh National Institute of Technology in South Korea. BatteryMetrix brought together the central themes of my doctoral work: predictive battery intelligence, explainable AI, secure lifecycle records, and immersive digital twins.", href: "/gallery" },
  { date: "July 19, 2025", category: "Seminar facilitation", title: "Anchored a PCDF seminar on practical personal finance", text: "I anchored a Prof. Cosmas Development Forum Zoom seminar with Chisom Mbaegbu at 2 p.m. West Africa Time. The conversation translated personal finance into accessible decisions about understanding one's financial position, managing income, building a sustainable savings habit, and approaching investment with greater confidence and discernment.", href: "https://www.facebook.com/share/p/1CdxCmjFe7/" },
  ...
  { date: "June 21, 2025", category: "Seminar facilitation", title: "Anchored a PCDF seminar on mental health and stress management for busy women", text: "I anchored a Prof. Cosmas Development Forum Zoom seminar with psychotherapist and Mindsplace founder Eniola Bello. The session addressed silent burnout, healthy boundaries, practical coping strategies, and the importance of protecting mental well-being while carrying demanding professional, family, and community responsibilities.", href: "https://www.facebook.com/share/p/19FFmM3Ja3/" },
  ...
  { date: "May 2025", category: "Education", title: "Defended the BatteryMetrix PhD thesis", text: "I successfully defended BatteryMetrix: A User-Centric Digital Twin Framework for Predictive, Explainable, and Secure Battery Management Systems at Kumoh National Institute of Technology.", href: "/research/batterymetrix" },
  ...
  { date: "2022", category: "Conference presentation", title: "Lithium-ion battery digital twin analysis presented at KICS Fall 2022", text: "At Lahan Select Hotel in Gyeongju, South Korea, I presented Analysis of Deep Neural Networks-Based Digital Twin for Lithium-ion Batteries with Robin Matthew Medina, Ebuka Chinaechetam Nkoro, Cosmas Ifeanyi Nwakanma, Jae-Min Lee, and Dong-Seong Kim. This work became an important foundation for BatteryMetrix.", href: "https://www.researchgate.net/publication/365878142_Analysis_of_Deep_Neural_Networks-Based_Digital_Twin_for_Lithium-ion_Batteries" },
  ...
  { date: "2020", category: "Conference presentation", title: "Radar waveform recognition presented at KICS Summer Conference", text: "In Pyeongchang, South Korea, I presented Automatic Radar Waveform Recognition using the Wigner-Ville Distribution and AlexNet-SVM with Manuel Eugenio Morocho-Cayamcela and Wansu Lim. The work combined time-frequency representations with deep feature extraction and support vector classification.", href: "https://www.researchgate.net/publication/343712491_Automatic_Radar_Waveform_Recognition_using_the_Wigner-Ville_distribution_and_AlexNet-SVM" },
  ...
  { date: "Mid-2020", category: "Service and leadership", title: "Joined WomenTech Network as a Global Ambassador", text: "I joined the WomenTech Network as a Global Ambassador representing South Korea, becoming part of a global community working to connect, amplify, and expand opportunities for women in technology.", href: "https://www.womentech.net/global-ambassadors/South%20Korea/Judith%20/Njoku-Vowels" },
  { date: "February 2020", category: "Conference", title: "ICAIIC 2020", text: "My first international conference chapter explored how autoencoders could reshape learning-enabled wireless communication systems.", href: "https://scholar.google.com/scholar?q=%22Learning+to+Communicate+with+Autoencoders%22+Njoku" },
  { date: "2019", category: "Research transition", title: "Joined the Future Communications Systems Laboratory", text: "After moving to Gumi, South Korea, for my MSc in Electronics Engineering, I joined the Future Communications Systems Laboratory at Kumoh National Institute of Technology. There I began working on modulation recognition, channel autoencoders, and deep learning for wireless communication.", href: "/about" },
  { date: "2019", category: "Conference presentation", title: "Blockchain and spectrum management presented at KICS", text: "I presented Hunger Marketing and Blockchain Technology: Applications in Wireless Spectrum Management with Manuel Eugenio Morocho-Cayamcela and Wansu Lim. This early work explored how demand-shaping strategies and distributed ledgers could support wireless spectrum management.", href: "https://scholar.google.com/scholar?q=%22Hunger+marketing+and+Blockchain+Technology%22" },
  { date: "2014", category: "Education", title: "BEng degree conferred", text: "I earned my Bachelor of Engineering in Petroleum Engineering from the Federal University of Technology, Owerri, Nigeria. That foundation taught me to approach engineering problems as interconnected physical systems.", href: "/gallery" },
];
