...
const journalNews: NewsItem[] = [
  ...
  { date: "December 2024", category: "Cohort 2 internship publication", title: "Estimation of Physico-Chemical Properties of Soil Using Machine Learning published in Smart Agricultural Technology", text: "I am excited to celebrate the first peer-reviewed publication from Cohort 2 of the Kyungpook National University and Michigan State University internship. With Patience Chizoba Mba and our collaborators, we developed and evaluated machine-learning methods for estimating soil properties that support agricultural decision-making. Seeing this internship research mature into a publication in Smart Agricultural Technology is a proud milestone for the students, mentors, and institutions behind the cohort.", href: "/publications" },
