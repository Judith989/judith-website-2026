...
const recentNews = [
  ...
  ["May 20, 2026", "Remote practical training research accepted", "Our paper on developing future workforce skills through remote practical training was accepted for publication in Computers and Education Open."],
];
