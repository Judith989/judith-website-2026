...
export const researchProjects: ResearchProject[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/research/iot-protocols/jcn1.png", alt: "Electric vehicle digital twin communication testbed", caption: "The experimental communication testbed links the physical electric vehicle, protocol clients, server terminal, and three-dimensional digital twin used for controlled protocol evaluation." },
      { src: "/research/iot-protocols/data-transmission-flow.png", alt: "Flowchart for transmitting physical electric vehicle data to its digital twin", caption: "The transmission workflow initializes the server and Raspberry Pi client, sends battery data continuously, records server metrics, and repeats the experiment consistently for every communication protocol." },
  ...
  },
  {
    ...
    images: [
      { src: "/research/service-advisor-ai/dealer.png", alt: "Service drive workflow in an automotive dealership", caption: "The dealership workflow maps how a service advisor receives a vehicle, translates customer concerns into repair work, coordinates technicians, and closes the service interaction." },
      { src: "/research/service-advisor-ai/dealer2.png", alt: "Explainable artificial intelligence workflow for service advisor performance analysis", caption: "The explainable AI workflow connects dealership performance data to predictive models and interpretable evidence for coaching, resource allocation, and operational decisions." },
  ...
  },
  {
    ...
    images: [
      { src: "/research/explainable-battery-twins/sys1.png", alt: "Explainable battery digital twin framework for state prediction", caption: "The complete framework connects battery measurements to DNN and LSTM digital twins, State of Charge and State of Health predictions, and explanation methods that expose why each estimate was produced." },
      { src: "/research/explainable-battery-twins/sys2.png", alt: "Study design for explainable battery state estimation", caption: "The study design traces data preparation, feature selection, digital-twin training, prediction, and comparative explanation through SHAP, LIME, and surrogate models." },
      { src: "/research/explainable-battery-twins/sys3.png", alt: "Explainability workflow for battery digital twin predictions", caption: "The explanation workflow translates a model prediction into local and global evidence that engineers can use to inspect the variables driving battery-state estimates." },
  ...
  },
  {
    ...
    images: [
      { src: "/research/secure-av-voice/av4.png", alt: "Complete secure autonomous vehicle speaker identification and blockchain event-recording workflow", caption: "The complete system workflow links authorized-speaker verification, vehicle control, accident detection, witness voting, and blockchain-backed event recording." },
      { src: "/research/secure-av-voice/av6.png", alt: "Speaker identification system model for autonomous vehicle access control", caption: "The speaker-identification model converts a driver utterance into acoustic features and an identity decision before permitting access to vehicle functions." },
      { src: "/research/secure-av-voice/av5.png", alt: "Cellular vehicular network connecting autonomous vehicles and infrastructure", caption: "The cellular vehicular network provides the communication layer through which accident vehicles, witness vehicles, roadside infrastructure, and remote services exchange evidence." },
      { src: "/research/secure-av-voice/av7.png", alt: "Blockchain records for accident voting and speaker identification", caption: "Separate blockchain records preserve witness votes and speaker-identification events, creating an auditable history for safety investigations." },
      { src: "/research/secure-av-voice/av3.png", alt: "Voice spoofing attack against an autonomous vehicle", caption: "The threat model shows how a replayed or synthesized voice can impersonate an authorized driver, motivating the project's identity-verification layer." },
      { src: "/research/secure-av-voice/av2.png", alt: "Authorized speaker identification concept for autonomous vehicles", caption: "Speaker identification narrows control privileges to enrolled users so that a spoken command is evaluated for both content and identity." },
      { src: "/research/secure-av-voice/av1.png", alt: "Levels of vehicle automation from driver assistance to full automation", caption: "The automation taxonomy situates the security problem across the transition from human-controlled vehicles to fully autonomous operation." },
  ...
  },
  {
    ...
    images: [
      { src: "/research/bat-gpt/system-overview.png", alt: "BAT-GPT model-in-the-loop battery digital twin and language assistant architecture", caption: "The complete BAT-GPT architecture links a capacity-predicting model-in-the-loop digital twin to prompt-response generation, FLAN-T5 adaptation, real-time battery data, and an interactive response loop." },
      { src: "/research/bat-gpt/prompt-response-workflow.png", alt: "Battery dataset prompt generation and digital twin conversation example", caption: "Battery measurements are converted into grounded prompt-response pairs, then used to teach the assistant how to explain capacity under specific current, temperature, cycle, and operating conditions." },
      { src: "/research/bat-gpt/flan-t5-architecture.png", alt: "FLAN-T5 encoder-decoder architecture used by BAT-GPT", caption: "The FLAN-T5 encoder-decoder architecture provides the language backbone, using attention and feed-forward blocks to transform battery prompts into contextual responses." },
      { src: "/research/bat-gpt/lora-fine-tuning.png", alt: "Low-rank adaptation method used to fine-tune BAT-GPT", caption: "LoRA freezes the pretrained language-model weights and learns compact low-rank update matrices, making domain adaptation more parameter efficient." },
